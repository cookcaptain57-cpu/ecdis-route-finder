  ...
  const doLogin = async () => {
    ...
    try {
      ...
      if (snap.exists() && snap.data().blocked) {
        ...
        setErr(
          "⚠️ ACCESS SUSPENDED — Suspicious login detected by admin. Contact owner on Instagram: @manish_the_navigator"
        );
      ...
      if (
        ...
        setErr(
          "⚠️ ACCESS SUSPENDED — Contact owner: @manish_the_navigator on Instagram"
        );
      } else {
      ...
      <div className="auth-card">
        ...
        <div className="auth-logo">
          ...
          <div className="auth-sub">
            {mode === "reset"
              ? "Reset Password"
              : "Free account · Download all files"}
          </div>
        </div>

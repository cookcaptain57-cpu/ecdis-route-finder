...
function RoutesPage({ searchQuery, notify, user, setTab }) {
  ...
  const loadAllRoutes = async () => {
    try {
      ...
      // HUGE LIMIT
      const res = await searchSheetLive(
        ROUTE_SHEET_ID,
        "",
        ROUTE_TABS,
        50000
  ...
  const suggestions = useMemo(() => {
    ...
    allRoutes.forEach((r) => {
      ...
      if (
        nm &&
        nm.toLowerCase().includes(search)
      ) {
        names.add(nm);
      }
    });
        ...
        <div className="files-grid">
          {results.map((r, i) => (
            ...
            >
              ...
              {getPort(r) && (
                <div className="file-port">
                  📍 {getPort(r)}
                </div>
              )}

              <div className="file-tags">
                <span className="ftag tag-rtz">
                  Route File
                </span>
